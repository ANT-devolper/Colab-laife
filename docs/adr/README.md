...
| [0011](0011-serve-spa-from-axum.md) | Serve the Elm SPA from the Axum binary (single origin) | Accepted |
| [0012](0012-public-disc-submission.md) | Public DISC submission (tenant resolved by schema, no auth) | Accepted |
