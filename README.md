...
- Elm SPA: a login page that obtains a session token, full sector and role management (create /
  edit / deactivate) and a read-only directory (collaborators), served from the Axum binary on
  the same origin. Covered by Playwright end-to-end tests.
